...
JOVAL_CORE=$(COMPONENTS)/sdk/engine
JOVAL_DEPS=$(subst $(SPACE),$(CLN),$(filter %.jar %.zip, $(wildcard $(JOVAL_CORE)/$(LIBDIR)/*)))
PLUGIN_SHARED=$(COMPONENTS)/sdk/plugin/shared
