...
<axsl:template match="ind-sc:filehash_item" priority="1000" mode="M32">
		...
		<!--REPORT -->
<axsl:if test="true()">DEPRECATED ITEM: <axsl:text/>
<axsl:value-of select="name()"/>
<axsl:text/> ID: <axsl:text/>
<axsl:value-of select="@id"/>
<axsl:text/>
         <axsl:value-of select="string('&#10;')"/>
</axsl:if>
...
<axsl:template match="ind-sc:ldap57_item/ind-sc:value" priority="1000" mode="M35">
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="@datatype='record'"/>
<axsl:otherwise>
            <axsl:text/>
<axsl:value-of select="../@id"/>
...
<axsl:template match="ind-sc:textfilecontent_item/ind-sc:line" priority="1000" mode="M38">
		...
		<!--REPORT -->
<axsl:if test="true()">DEPRECATED ELEMENT: <axsl:text/>
<axsl:value-of select="name()"/>
<axsl:text/> ID: <axsl:text/>
<axsl:value-of select="@id"/>
<axsl:text/>
...
<axsl:if test=".='LDAPTYPE_TIMESTAMP'">
                                                  DEPRECATED ELEMENT VALUE IN: ldap_item ELEMENT VALUE: <axsl:text/>
...
<!--PATTERN macos-sc_inetlisteningserveritem_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:inetlisteningserver_item" priority="1000" mode="M48">
...
<!--PATTERN unix-sc_processitem_dep-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:process_item" priority="1000" mode="M50">
...
<!--PATTERN unix-sc_sccsitem_dep-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:sccs_item" priority="1000" mode="M51">
...
<!--PATTERN win-sc_activedirectory_item_dep-->
	...
	<!--RULE -->
<axsl:template match="win-sc:activedirectory_item" priority="1000" mode="M52">
...
<!--PATTERN win-sc_activedirectory57_itemvalue-->
	...
	<!--RULE -->
<axsl:template match="win-sc:activedirectory57_item/win-sc:value" priority="1000" mode="M53">
...
<!--PATTERN win-sc_fileaudititemtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:trustee_name" priority="1000" mode="M54">
...
<!--PATTERN win-sc_feritemtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:trustee_name" priority="1000" mode="M55">
...
<!--PATTERN win-sc_regitemkey-->
	...
	<!--RULE -->
<axsl:template match="win-sc:registry_item/win-sc:key" priority="1000" mode="M56">

		<!--ASSERT -->
<axsl:choose>
<axsl:when test="not(@xsi:nil=true()) or ../win-sc:name/@xsi:nil=true()"/>
<axsl:otherwise>
            <axsl:text/>
<axsl:value-of select="../@id"/>
...
<!--PATTERN win-sc_rapitemtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:trustee_name" priority="1000" mode="M57">
...
<!--PATTERN win-sc_rapitemstandard_synchronize-->
	...
	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:standard_synchronize" priority="1000" mode="M58">
...
<!--PATTERN win-sc_reritemtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:trustee_name" priority="1000" mode="M59">
...
<!--PATTERN win-sc_reritemstandard_synchronize-->
	...
	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:standard_synchronize" priority="1000" mode="M60">
...
<!--PATTERN win-sc_wmi_item_dep-->
	...
	<!--RULE -->
<axsl:template match="win-sc:wmi_item" priority="1000" mode="M61">
...
<!--PATTERN win-sc_wmi57_itemresult-->
	...
	<!--RULE -->
<axsl:template match="win-sc:wmi57_item/win-sc:result" priority="1000" mode="M62">
