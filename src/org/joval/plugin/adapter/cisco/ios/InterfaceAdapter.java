...
public class InterfaceAdapter implements IAdapter {
    ...
    public InterfaceAdapter(IIosSession session) {
	this.session = session;
    }

    // Implement IAdapter

    private static Class[] objectClasses = {InterfaceObject.class};
    ...
    private Collection<InterfaceItem> getItems() throws CollectionException {
