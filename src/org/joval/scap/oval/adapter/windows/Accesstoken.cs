...
namespace jOVAL {
	...
	public class Probe {
		...
		(String SystemName, ref LSA_OBJECT_ATTRIBUTES ObjectAttributes, Int32 DesiredAccess, out IntPtr PolicyHandle);
		...
		(IntPtr PolicyHandle, IntPtr AccountSid, out IntPtr UserRights, out UInt32 CountOfRights);
