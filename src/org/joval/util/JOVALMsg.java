...
public enum JOVALMsg {
    ...
    ERROR_DPKGINFO_LINE,
    ERROR_ENGINE_EVAL_CANCELLED,
    ERROR_ENGINE_SCAN_CANCELLED,
    ERROR_ENGINE_STATE,
    ERROR_EXCEPTION,
    ...
    ERROR_MODE_SC,
    ERROR_OBJECT_OVERFLOW,
    ERROR_OBJECT_PERMUTATION,
    ERROR_OCIL_BAD_SOURCE,
    ERROR_OCIL_REQUIRED,
    ERROR_OCIL_VARS,
    ERROR_OVAL,
    ERROR_OVAL_LOOP,
    ...
    STATUS_EMPTY_ENTITY,
    STATUS_EMPTY_FILE,
    STATUS_EMPTY_OBJECT_COMPONENT,
    STATUS_EMPTY_OBJECT_COMPONENT_RECORD,
    STATUS_EMPTY_RECORD,
    STATUS_EMPTY_SET,
    STATUS_FILEHASH,
    STATUS_FILTER,
    ...
    STATUS_NOT_FILE,
    STATUS_OBJECT_BATCH,
    STATUS_OBJECT_ITEM_ASSOC,
    STATUS_OBJECT_MESSAGE,
    STATUS_OBJECT_NOITEM_ASSOC,
    STATUS_OBJECT_ITEM_MAP,
    STATUS_OBJECT_NOITEM_MAP,
    STATUS_OBJECT_QUEUE,
    STATUS_OVAL_DEFINITION,
    STATUS_OVAL_EVAL,
    STATUS_OVAL_EVAL_COMPLETE,
    STATUS_OVAL_OBJECT,
    STATUS_OVAL_SCANNING,
    STATUS_OVAL_SCAN_COMPLETE,
    STATUS_PE_DEVCLASS,
    STATUS_PE_EMPTY,
    STATUS_PE_READ,
    STATUS_PRO_DB,
    ...
    STATUS_WIN_WUA,
    STATUS_XCCDF_APPLICABILITY,
    STATUS_XCCDF_APPLICABLE,
    STATUS_XCCDF_CONVERT,
    STATUS_XCCDF_NOPROFILE,
    STATUS_XCCDF_NOTAPPLICABLE,
    STATUS_XCCDF_OVAL,
    STATUS_XCCDF_PLATFORM_CHECK,
    STATUS_XCCDF_RULE,
    STATUS_XCCDF_RULES,
    STATUS_XCCDF_RULES_DONE,
    STATUS_XCCDF_SCORE,
    STATUS_XCCDF_SELECTED,
    STATUS_XINETD_FILE,
    STATUS_XINETD_NOCONFIG,
    STATUS_XINETD_SERVICE,
    STATUS_XML_INIT,
    WARNING_ARF_REQUEST,
    WARNING_BATCH_INTERRUPTED,
    WARNING_CPE_MULTIDICTIONARY,
    WARNING_CPE_NODICTIONARY,
    WARNING_CPE_TARGET,
    WARNING_CPE_URI,
    WARNING_FILEHASH_LINES,
    WARNING_ITEM_FIELD_STATUS,
    WARNING_NS_PREFIX,
    WARNING_OBJECT_INTERRUPTED,
    WARNING_RECORD_FIELD_STATUS,
    WARNING_REGEX_GROUP,
