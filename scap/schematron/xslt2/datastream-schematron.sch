 ...
 xmlns:xsl="http://www.w3.org/1999/XSL/Transform" queryBinding="xslt2">
  ...
  <sch:pattern id="scap-general">
    ...
    <sch:rule id="scap-general-scap-content" context="scap:data-stream">
      <!-- JovalCM: java functions not supported
      ...
      -->
      <sch:assert id="scap-general-scap-content-every-cpe-equal-subset2" test="true()">SRC-15-1|scap:data-stream <sch:value-of select="@id"/></sch:assert>
  ...
  <sch:pattern id="scap-additional-rules">
    ...
    <sch:rule id="scap-collection" context="scap:data-stream-collection">
      <!-- JovalCM: alteration because SaxonHE does not support Java assertions.
      ...
      -->
      <sch:assert flag="WARNING" test="false()" id="scap-collection-java-functions">A-22-1</sch:assert>
    </sch:rule>
  </sch:pattern>
